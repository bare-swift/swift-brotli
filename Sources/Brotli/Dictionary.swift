...
//
// This file is auto-generated by scripts/generate_dictionary.py from
// https://github.com/google/brotli/blob/master/c/common/dictionary.bin
// (MIT-licensed; see NOTICE).
//
// Source SHA-256: 20e42eb1b511c21806d4d227d07e5dd06877d8ce7b3a817f378f313653f35c70

/// The 122784-byte Brotli static dictionary from RFC 7932 Appendix A.
///
/// Words are indexed by length (4..24). For word-length `L`, the
/// dictionary contains `counts[L]` words, each `L` bytes, packed
/// contiguously starting at `bytes[offsets[L]]`.
enum Dictionary {
    /// Byte offset within `bytes` for each word-length 0..24.
    /// Lengths 0..3 are unused (Brotli dictionary words start at
    /// length 4); offsets for those indices are 0.
    ...
    /// Number of words at each length (index by length 0..24).
    /// Length 0..3 are unused.
    static let counts: [Int] = [
        0, 0, 0, 0, 1024, 1024, 1024, 1024, 2048, 2048,
        2048, 2048, 2048, 2048, 1024, 1024, 1024, 1024,
        1024, 512, 512, 512, 512, 512, 512,
    ]
